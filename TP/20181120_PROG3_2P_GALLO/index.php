...
require_once './clases/MWCheckSegundos.php';
   ...
   $this->group('', function()
      {
         ...
         $this->get('/hora',\compraApi::class . ':obtenerHora')->add(\MWCheckSegundos::class . ':verificarSegundos')->setName('hora');#7
         $this->get('/productos',\compraApi::class . ':productosVendidos')->setName('productos');#9
