...
function modificarAlumno($archivoAlumnos,$carpetaFotos,$carpetaBkp)
{
    if($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        && isset($_POST["nombre"]) && isset($_FILES["foto"]))
        {
            ...
            $listAlumnos = CSVtoArrayObj("alumno",$archAlumnos);
            $i;
