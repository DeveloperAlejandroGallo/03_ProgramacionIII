...
$app->group('', function () {//grupo para todos 
    ...
    {//grupo para las que necesitan web token
        ...
        $this->get('compra/marca', \compraApi::class . ':ListaModelosPorMarca')->add(\MiddlewareAPI::class . ':VerificarPerfilUsuarioMarca');
        $this->get('productos', \compraApi::class . ':ListadoModelos');
